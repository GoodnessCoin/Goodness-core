...
#ifdef _WIN32
const std::string goodnessDaemon = "goodnessd.exe";
#else
const std::string goodnessDaemon = "goodnessd";
#endif
...
TestNodeConfiguration TestNetworkBuilder::buildNodeConfiguration(size_t index) {
  ...
  cfg.daemonPath = goodnessDaemon; // default
  cfg.testnet = testnet;
  cfg.logFile = "test_goodnessd" + std::to_string(index) + ".log";
