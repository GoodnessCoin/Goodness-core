...
const uint64_t WRITE_BUFFER_MB_DEFAULT_SIZE = DB_WRITE_BUFFER_MB_DEFAULT_SIZE;
const uint64_t READ_BUFFER_MB_DEFAULT_SIZE = DB_READ_BUFFER_MB_DEFAULT_SIZE;
const uint32_t DEFAULT_MAX_OPEN_FILES = DB_DEFAULT_MAX_OPEN_FILES;
const uint16_t DEFAULT_BACKGROUND_THREADS_COUNT = DB_DEFAULT_BACKGROUND_THREADS_COUNT;
